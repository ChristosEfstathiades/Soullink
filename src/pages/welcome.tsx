...
export default function Welcome() {
    ...
    return (
        <>
            <div className="flex flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:p-8 dark:bg-[#141616]">
                <header className="mb-6 w-full text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-between gap-4">
                        <Link to="/" className="flex items-center space-x-2 dark:text-[#EDEDEC]">
                            <AppLogo />
                        </Link>
                        <div>
                            <Link
                ...
                <section className="flex flex-col">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="mb-2 max-w-90 text-xs dark:text-[#EDEDEC]">
                            ...
                            . Track your encounters and Build your best possible combined team. Your data is stored in this browser — use
                            export/import to back it up or move it between devices.
                        </p>
                        <Link
                            to="/saves"
                ...
                <div className="mx-auto w-[85%]">
                    ...
                    <Tutorial image="tutorial_9.png" number={9}>
                        <TutorialContent>
                            ...
                            <TutorialDescription>
                                Click Settings {'->'} Appearance {'->'} PC box wallpaper to change your PC box background
                            </TutorialDescription>
                        </TutorialContent>
                    </Tutorial>
                </div>
